...
A fork of the iSH Shell project to which aims to create a Linux shell running on iOS, using usermode x86 emulation and syscall translation.

For the current status of the project, check the issues tab, and the commit logs.

- [App Store page]()
- [TestFlight beta](https://testflight.apple.com/join/X1flyiqE)
- [Discord server](https://discord.com/channels/776432683302649866/776432683302649870)
